...
`bryanunitek/UniCORE.BIND9` is the **BIND9** family member: On-prem-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source authoritative + recursive DNS — primary DNS substrate for UniCORE.GVB nodes.

---

## Upstream

- **Upstream project:** https://gitlab.isc.org/isc-projects/bind9
...
UniCORE.BIND9 is published as a **four-repo family**:

- `bryanunitek/UniCORE.BIND9` — public on-prem-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniSaaS.UniCORE.BIND9` — public SaaS-deployment-shape gift surface
- `bryanunitek/UniCORE.BIND9-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.BIND9-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniCORE.BIND9/discussions)
